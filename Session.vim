...
set helplang=en
set laststatus=2
set runtimepath=~/.vim,~/.vim/plugged/vim-colors-solarized/,~/.vim/plugged/vim-airline/,~/.vim/plugged/vim-airline-themes/,~/.vim/plugged/tmuxline.vim/,~/.vim/plugged/vim-jade/,~/.vim/plugged/vim-coffee-script/,~/.vim/plugged/vim-ls/,~/.vim/plugged/vim-stylus/,~/.vim/plugged/vim-terminal/,~/.vim/plugged/emmet-vim/,~/.vim/plugged/webapi-vim/,/usr/local/share/vim/vimfiles,/usr/local/share/vim/vim81,/usr/local/share/vim/vimfiles/after,~/.vim/plugged/vim-coffee-script/after,~/.vim/after
set shiftwidth=2
set showtabline=2
set splitbelow
set splitright
...
silent only
silent tabonly
cd ~/stuff/src/javascript/suite.js/doleout.js
...
silent! normal! zE
let s:l = 262 - ((31 * winheight(0) + 30) / 61)
...
wincmd w
argglobal
terminal ++curwin ++cols=112 ++rows=30 
setlocal keymap=
setlocal noarabic
